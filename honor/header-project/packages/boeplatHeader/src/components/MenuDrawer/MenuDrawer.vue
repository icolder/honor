  ...
  >
    <div class="menu-drawer-box-body beauty-scroll">
      <div class="menu-drawer-box-body-search" @mouseenter="isSearchEnter" @mouseleave="isSearchLeave">
        ...
        <img :src="searchActiveLogo" v-if="isSearch" />
        <!-- <img src="../../assets/header/menu-search.svg" v-else /> -->
        <img :src="searchLogo" v-else />
...
import searchActiveLogo from "../../assets/header/menu-search-active.svg";
import searchLogo from "../../assets/header/menu-search.svg";
export default {
